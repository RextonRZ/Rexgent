...
/** Claude-Code-style process log: current stage flow + collapsed done steps. */
export function AgentPanelContent({ projectId }: { projectId: string }) {
  ...
  const name = (key: string) =>
    registry?.find((a) => a.key === key)?.name || key;
